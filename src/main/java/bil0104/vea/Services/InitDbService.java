...
public class InitDbService {
    ...
    public void init() {
        ...
        subs.add(new Subject("UDBS", "Úvod do dbs", 2, Semester.SUMMER, 4, null, teas.get(0)));
        subs.add(new Subject("AVD", "Algority vykonání dotazů", 5, Semester.SUMMER, 5, null, teas.get(0)));
        subs.add(new Subject("ADBS", "Administrace DBS", 3, Semester.WINTER, 3, null, teas.get(0)));
